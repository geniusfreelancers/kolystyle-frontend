...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS = {"/error", "/css/**", "/js/**", "/image/**","/rest/cart/**", "/","/index","/currentdeals", "/newUser","/forgetPassword","/forgotpassword","/login","/register","/fonts/**","/home","/productshelf","/productDetail","/public/**","/productsByTags","/searchByBrand","/searchByCategory","/searchBySubCategory","/searchBySubSubCategory","/searchProduct","/productByGender","/shoppingCart/**","/paypal/**","/checkouts/**","/cart/guestcheckout","/customize/**","/chargeguest","/thankyou/**","/newsletter/**","/ordertracking/**","/guest/charge","/guest/checkout","/products" };
