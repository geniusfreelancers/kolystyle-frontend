...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS = { "/css/**", "/js/**", "/image/**","/rest/cart/**", "/","/index", "/newUser","/forgetPassword","/forgotpassword","/login","/register","/fonts/**","/home","/productshelf","/productDetail","/public/**","/searchByBrand","/searchByCategory","/searchBySubCategory","/searchProduct","/shoppingCart/**","/paypal/**","/checkouts/**","/cart/guestcheckout","/customize/**","/chargeguest","/thankyou/**","/newsletter/**","/ordertracking/**","/guest/charge","/guest/checkout" };
