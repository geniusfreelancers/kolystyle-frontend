...
public class ChargeController {
    ...
    @PostMapping("/charge")
    public String charge(ChargeRequest chargeRequest, Model model,@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
      ...
      throws StripeException {
        chargeRequest.setDescription("Koly Style Product Purchase");
